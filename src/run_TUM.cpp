...
int main(int argc, char** argv){
    ...
    if(argc!=6){
        std::cout << "Please the following terms:\n"
                ...
                //   << "5. The number that the sequence belongs to\n"
        ...
        folder = argv[4];
        // stringstream dataset_seq(argv[5]);
        // dataset_seq >> cfg_.dataset_seq;
        // std::cout << std::endl << "Current sequence belongs to number: " << cfg_.dataset_seq << std::endl;
        association = argv[5];
    }
